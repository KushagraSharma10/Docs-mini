...
const Card = ({ data , reference }) => {
  return (
    <motion.div drag dragConstraints = {reference} whileDrag={{scale:1.2}} className="relative flex-shrink-0 w-[15vw] h-[33vh] rounded-[3vw] bg-zinc-900/90 text-white px-8 py-10 overflow-hidden">
      <FaRegFileAlt />
